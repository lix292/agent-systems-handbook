---
title: "Codex 工作坊 Mac 设置"
description: "创建或确认你的 ChatGPT 账号，在 macOS 上安装 Codex app，并在克隆仓库前完成登录。"
...
这条设置路线面向想先把 Codex 作为桌面编码智能体准备好、再连接 GitHub
Desktop 和克隆 handbook 的 macOS 用户。
